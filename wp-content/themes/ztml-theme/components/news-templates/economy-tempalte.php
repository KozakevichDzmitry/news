...
function render_economy_news_template($is_minimazed = false)
{
?>
	<?php render_topic_bar("Экономика", true, array(
		'link' => get_site_url() . '/news-list/ekonomika-2/',
	...
	<?php $economy_attached_posts = get_attached_news('2', 'ekonomika-2'); ?>
	<?php $economy_posts = get_default_news('5', 'ekonomika-2', $economy_attached_posts['ids']); ?>
	...
	<div class="box-column-gap" style="margin-bottom: 30px;">
		...
		<?php else : ?>
			...
			<div class="box">
				<?php render_news_template_line($economy_posts[4]->ID, true, false); ?>
			</div>
		<?php endif; ?>
	</div>
<?php

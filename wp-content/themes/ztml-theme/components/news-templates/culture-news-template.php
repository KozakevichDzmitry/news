...
?>
	<?php render_topic_bar("Культура", true, array(
		'link' => get_site_url() . '/news-list/kultura/',
	...
	<?php $culture_attached_posts = get_attached_news('1', 'kultura'); ?>
	<?php $culture_economy_posts = get_default_news('3', 'kultura', $culture_attached_posts['ids']); ?>


	<div class="box-column-gap" style="margin-bottom: 30px;">
		<div class="box">
			<?php render_news_template_line($culture_economy_posts[0]->ID, true, false); ?>
		</div>
		<div class="box-line-reverse-gap">
			<div class="box">
				<?php render_new_template_image($culture_attached_posts['posts'][0]->ID); ?>
			</div>
			<div class="box box-list">
				<?php render_news_template_line($culture_economy_posts[1]->ID, false, true); ?>
				<?php render_news_template_line($culture_economy_posts[2]->ID, false, true); ?>
			</div>
		</div>
	</div>
<?php

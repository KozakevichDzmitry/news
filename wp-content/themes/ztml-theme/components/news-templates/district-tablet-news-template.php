...
function render_district_tablet_news_template()
{
	$district_item = array(
		'title' => 'Центральный',
...
?>
	<div class="district-tablet-template">
		<div class="district-item active">
			<div>
				<div class="district-preview__title">
					<?php echo 'Центральный' ?>
				</div>
				<div class="content">
					<img src="<?php echo get_template_directory_uri() . $district_item['image']; ?>" alt="" />
		...
		<div class="districts-list">
			<ul>
				<?php foreach ($districts as $item) : ?>
					<li>
						<img src="<?php echo get_template_directory_uri() . $item['image']; ?>" alt="<?php $item['title']; ?> район" />

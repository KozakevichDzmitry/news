...
?>
	<?php render_topic_bar("Происшествия", true, array(
		'link' => get_site_url() . '/news-list/proishestviya/',
	...
	<div class="box-column-gap" style="margin-bottom: 30px;">
		<div class="box">
			<?php render_news_template_line($query_pallete[0]->ID, true, false); ?>
		</div>
		<div class="box-line-reverse-gap">
			<div class="box">
				<?php render_new_template_image($query_pallete[1]->ID); ?>
			</div>
			<div class="box box-list">
				<?php render_news_template_line($query_pallete[2]->ID, false, true); ?>
				<?php render_news_template_line($query_pallete[3]->ID, false, true); ?>
			</div>
		</div>
		<div class="box-line-gap">
			<div class="box">
				<?php render_new_template_image($query_pallete[4]->ID); ?>
			</div>
			<div class="box box-list">
				<?php render_news_template_line($query_pallete[5]->ID, false, true); ?>
				<?php render_news_template_line($query_pallete[6]->ID, false, true); ?>
			</div>
		</div>
	</div>

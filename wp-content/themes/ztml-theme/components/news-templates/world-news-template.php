...
?>
	...
	<?php $world_news_attached_posts = get_attached_news('1', 'novosti-mira'); ?>
	<?php $world_news_posts = get_default_news('3', 'novosti-mira', $world_news_attached_posts['ids']); ?>

	<div class="box-column-gap" style="margin-bottom: 30px;">
		<div class="box">
			<?php render_news_template_line($world_news_posts[0]->ID, true, false); ?>
		</div>
		<div class="box-line-reverse-gap">
			<div class="box">
				<?php render_new_template_image($world_news_attached_posts['posts'][0]->ID); ?>
			</div>
			<div class="box box-list">
				<?php render_news_template_line($world_news_posts[1]->ID, false, true); ?>
				<?php render_news_template_line($world_news_posts[2]->ID, false, true); ?>
			</div>
		</div>
	</div>
<?php

...
?>
	<?php render_topic_bar("Палитра дня", true, array(
		'link' => get_site_url() . '/news-list/palitra-dnya/',
	...
	<?php $pallete_news_attached_posts = get_attached_news('1', 'palitra-dnya'); ?>
	<?php $pallete_news_posts = get_default_news('3', 'palitra-dnya', $pallete_news_attached_posts['ids']); ?>
	...
	<div class="box-column-gap" style="margin-bottom: 30px;">
		...
		<div class="box">
			<?php render_news_template_line($pallete_news_posts[2]->ID, true, true); ?>
		</div>
	</div>
<?php
}

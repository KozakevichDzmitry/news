...
?>
	<div class="main-news-cat box-line-gap" class="box-line-gap" style="margin-bottom: 30px;">
		<div class="main-news-list" style="display: flex;flex-direction: column;">
			...
			<div class="box-column-gap" style="height: 100%;">
				<div class="box" style="padding: 10px;height: 50%;">
					<?php render_new_template_image($top_news_posts[0]->ID); ?>
				</div>
				<div class="box" style="padding: 10px;display: flex;gap: 10px;">
					<?php render_news_template_line($top_news_posts[1]->ID, true, false, true); ?>
					<?php render_news_template_line($top_news_posts[2]->ID, true, false, true); ?>
				</div>
			</div>
		</div>

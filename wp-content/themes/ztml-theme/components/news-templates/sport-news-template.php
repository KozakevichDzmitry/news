...
?>
	...
	<?php $sport_attached_posts = get_attached_news('1', 'sport'); ?>
	<?php $sport_posts = get_default_news('3', 'sport', $sport_attached_posts['ids']); ?>
	...
	<div class="box-column-gap" style="margin-bottom: 30px;">
		...
		<div class="box">
			<?php render_news_template_line($sport_posts[2]->ID, true, true); ?>
		</div>
	</div>
<?php
}

...
function render_urban_economy_news_template($is_minimazed = false)
{
?>
	<?php render_topic_bar("Городское хозяйство", true, array(
		'link' => get_site_url() . '/news-list/ekonomika/',
	...
	<?php $urban_economy_attached_posts = get_attached_news('2', 'ekonomika'); ?>
	<?php $urban_economy_posts = get_default_news('5', 'ekonomika', $urban_economy_attached_posts['ids']); ?>
	...
	<div class="box-column-gap" style="margin-bottom: 30px;">
		...
		<?php else : ?>
			<div class="box">
				<?php render_news_template_line($urban_economy_posts[0]->ID, true, false); ?>
			</div>
			<div class="box-line-reverse-gap">
				<div class="box">
					<?php render_new_template_image($urban_economy_attached_posts['posts'][0]->ID); ?>
			...
			<div class="box-line-gap">
				...
				<div class="box box-list">
					...
					<?php render_news_template_line($urban_economy_posts[4]->ID, false, true); ?>
				</div>
			</div>
		<?php endif; ?>
	</div>

...
?>
	...
	$most_read_posts = $most_read_quary->posts;
	?>
	...
	<?php if ($is_minimazed) : ?>
		<div class="box-column-gap" style="margin-bottom: 30px;">
			...
			<div class="box">
				<?php render_news_template_line($most_read_posts[3]->ID, true, true); ?>
			</div>
		</div>
	<?php else : ?>
		<div class="box-column-gap" style="margin-bottom: 30px;">
			...
			<div class="box">
				<?php render_news_template_line($most_read_posts[3]->ID, true, false); ?>
			</div>
			<div class="box-line-reverse-gap">
				<div class="box">
					<?php render_new_template_image($most_read_posts[4]->ID); ?>
				</div>
				<div class="box box-list">
					<?php render_news_template_line($most_read_posts[5]->ID, false, true); ?>
					<?php render_news_template_line($most_read_posts[6]->ID, false, true); ?>
				</div>
			</div>
			<div class="box">
				<?php render_news_template_line($most_read_posts[7]->ID, true, true); ?>
			</div>
		</div>
	<?php endif; ?>
<?php

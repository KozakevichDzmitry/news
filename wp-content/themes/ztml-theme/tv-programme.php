			...
			<div class="main-content">
				...
				<div class="mob-container">
					...
					<div class="tv-programme_container">
						...
						<p class="tv-programme__text">На портале minsknews.by представлена ТВ-программа не только на сегодня. Вы можете узнать, во сколько покажут любимую передачу, новости или сериал, например, завтра, просто выбрав кнопку с днем и датой. Всё максимально просто и удобно.</p>
					</div>
					<div>

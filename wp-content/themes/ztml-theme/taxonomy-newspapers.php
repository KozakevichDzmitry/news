                ...
                <div class="main-content">
                    ...
                    <?php if ($topic_title === 'Качели') : ?>
                        <div class="newspaper__kacheli-content">
                            <img src="https://minsknews.by/wp-content/uploads/2020/02/logotip-poslednij-900x318.png"/>
                            ...
                            <div class="kacheli-content">
                                ...
                                <div class="list">
                                    ...
                                    <ul class="items-list">
                                        <li>Ребятам 6-11 лет, которые с любопытством открывают и изучают окружающий
                                            мир;
                                        </li>
                                        <li>Родителям, которые хотят больше времени проводить со своими детьми;</li>
                                        <li>Бабушкам и дедушкам, которые готовы вместе с ребятами читать сказки, изучать
                                            родной язык, мастерить поделки и разгадывать сканворды;
                                        </li>
                                        <li>Педагогам и воспитателям, для которых журнал может стать добрым помощникам
                                            на классном часу.
                                        </li>
                                        <li>Педагогам и воспитателям, для которых журнал может стать добрым помощникам
                                            на классном часу.
                    ...
                    <?php if (intval($show_count) < count($all_posts)) { ?>
                        <button class="newspaper__moree-btn btn-loadmore"
                                data-param-posts='<?php echo serialize($args); ?>' data-tpl='pdf-attacments'
                                data-load-posts="<?php echo $load_count ?>" data-show-posts="<?php echo $show_count ?>"
                                data-all-posts="<?php echo count($all_posts) ?>">
                            Показать ещё
                        </button>
                    <?php } ?>
                </div>

				...
				<div class="about-content">
						...
						<?php foreach (carbon_get_the_post_meta('numbers') as $item) : ?>
							<div class="card">
								<div class="card__icon">
									<img src="<?php echo wp_get_attachment_image_url($item['image']) ?>" alt="">
								</div>
					...
					<div class="socials-links">
						<?php foreach (carbon_get_the_post_meta('about_socials') as $item) : ?>
							<a href="<?php echo $item['link'] ?>"><img src="<?php echo wp_get_attachment_image_url($item['icon']) ?>" alt="social link"></a>
						<?php endforeach ?>
					</div>
					...
					<div class="info">
						<?php foreach (carbon_get_the_post_meta('numbers2') as $item) : ?>
							<div class="card">
								<div class="card__icon">
									<img src="<?php echo wp_get_attachment_url($item['image']) ?>" alt="">
								</div>
								<div class="card__content">
